...
?>    
    <div class="flex items-center justify-center w-full h-full px-2">
      <div onclick="event.cancelBubble=true;" class="bg-[#0e0e0e] md:min-w-[800px] md:w-auto w-full max-w-[800px] max-h-[80vh] overflow-y-auto flex flex-col gap-4 rounded-2xl sm:px-6  -xl">
        <form action="scripts/users/save_profile.php" method="POST" enctype="multipart/form-data" id="popupItself" class="flex h-auto w-full justify-between flex-col">
          <div class="sticky z-[10] top-0 bg-[#0e0e0e] flex flex-row items-center justify-between sm:px-0 px-4 border-b border-white/10">
            ...
            <div class="text-center flex items-center">
                  ...
                  <button onclick="popupProfileCloseConfirm()" type="button" class="rounded-md text-gray-300 hover:text-gray-500 hover:rotate-90 duration-150 focus:outline-none focus:ring-2 theme-ring-focus focus:ring-offset-2">
          ...
          <div>
            <div>
              <label for="fileToUploadbg" class="theme-text-hover duration-150 cursor-pointer">
            ...
            <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
              <div class="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                <div class="flex">
                  <label for="fileToUploadprofile" class="theme-text-hover duration-150 cursor-pointer">
              ...
              <!-- detail section -->
              <div class="flex md:flex-row flex-col justify-between gap-2 text-gray-500 text-xs mt-3">
                ...
                <div>
                  <p>Zmiany grafik mogą nie być widoczne od razu, aby wczytać nowe obrazy kliknij <span class="theme-text">ctr + f5</span>.</p>
                </div>
              </div>
                  ...
                  <dl class="grid grid-cols-1">
                    ...
                    <div class="grid md:grid-cols-3 grid-cols-1 w-full gap-4">
                      ...
                      <div class="px-4 py-2 sm:px-0 col-span-2">
                        ...
                        <input name="desc" type="text" value="<?=$about?>" class="w-full text-gray-400 text-sm focus:text-white bg-[#0e0e0e] focus:ring-0 focus:outline-0 border-b border-white/10 py-2 theme-border-focus duration-150"></input>
                      </div>
                    </div>
                  </dl>
                </div>
...
<section id="popupProfileCloseBg" class="fixed z-[50] h-0 opacity-0 top-0 left-0 w-full h-full bg-[#0000009e] transition-opacity duration-300"></section>
  <section id="popupProfileClose" onclick="popupProfileCloseConfirm()" class="z-[70] fixed scale-0 top-0 left-0 w-full h-full">
    <div class="flex items-center justify-center w-full h-full px-2">
      <div onclick="event.cancelBubble=true;" id="pupupFaqDeleteOutput">
        <div class="relative transform overflow-hidden rounded-lg bg-[#1c1c1c] px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
          ...
          <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
            <button onclick="popupProfileOpenClose()" type="button" class="active:scale-95 duration-150 inline-flex w-full justify-center rounded-md bg-yellow-600 duration-150 px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-yellow-500 sm:ml-3 sm:w-auto">Nie zapisuj</button>
            <button onclick="popupProfileCloseConfirm()" type="button" class="active:scale-95 duration-150 mt-3 inline-flex w-full justify-center rounded-md px-3 py-2 text-sm font-medium text-gray-300 shadow-sm ring-inset ring-1 ring-[#3d3d3d] hover:bg-[#3d3d3d] duration-150 sm:mt-0 sm:w-auto">Zostań</button>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  <script>
    function popupProfileCloseConfirm() {
        var popup = document.getElementById("popupProfileClose")
        var popupBg = document.getElementById("popupProfileCloseBg")
