            ...
            echo '<input type="hidden" name="buildings_num" value="'.$quantity.'">';
                ...
                while($row=mysqli_fetch_assoc($result)){
                    ...
                    <div class="p-3 border border-[#3d3d3d] rounded-xl">
                        ...
                        <input name="build_id_'.$i.'_name" type="text" value="'.$row['name'].'" placeholder="Nazwa" class="placeholder:text-gray-600 capitalize w-full text-gray-400 text-sm focus:text-white bg-black/10 focus:ring-0 focus:outline-0 border-b border-white/10 py-2 theme-border-focus duration-150" required></input>
                        <input name="build_id_'.$i.'_street" type="text" value="'.$row['street'].'" placeholder="Ulica" class="placeholder:text-gray-600 w-full text-gray-400 text-sm focus:text-white bg-black/10 focus:ring-0 focus:outline-0 border-b border-white/10 py-2 theme-border-focus duration-150" required></input>
                ...
                if($saved_builds < $quantity) {
                    while($quantity>$i){
                        ...
                        <div class="p-3 border border-[#3d3d3d] rounded-xl">
                            <dt class="text-sm font-medium leading-6 text-gray-300 text-xs text-center"></dt>
                            <input name="build_id_'.$i.'_name" type="text" value="" placeholder="Nazwa" class="placeholder:text-gray-600 capitalize w-full text-gray-400 text-sm focus:text-white bg-black/10 focus:ring-0 focus:outline-0 border-b border-white/10 py-2 theme-border-focus duration-150" required></input>
                            <input name="build_id_'.$i.'_street" type="text" value="" placeholder="Ulica" class="placeholder:text-gray-600 w-full text-gray-400 text-sm focus:text-white bg-black/10 focus:ring-0 focus:outline-0 border-b border-white/10 py-2 theme-border-focus duration-150" required></input>
                            <input name="build_id_'.$i.'_city" type="text" value="" placeholder="Miasto" class="placeholder:text-gray-600  w-full text-gray-400 text-sm focus:text-white bg-black/10 focus:ring-0 focus:outline-0 border-b border-white/10 py-2 theme-border-focus duration-150" required></input>
                        </div>
                        ';
                        $i++;
                    }
