        ...
        <div class="relative transform overflow-hidden rounded-lg bg-[#1c1c1c] px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
          ...
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              <h3 class="text-base font-semibold leading-6 text-gray-200" id="modal-title">Wyrzuć <?=$name?> <?=$sur_name?> z korepetycji</h3>
              <div class="mt-2">
                <p class="text-sm text-gray-400">Czy na pewno chcesz wyrzucić <?=$name?> <?=$sur_name?> z korepetycji?</p>
              </div>
            </div>
          </div>
          <form action="scripts/korepetycje/kick.php" method="POST" class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              ...
              <button class="active:scale-95 duration-150 inline-flex w-full justify-center rounded-md bg-red-600 duration-150 px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Wyrzuć</button>
