    ...
    <dl class="">
        <div class="grid md:grid-cols-6 gap-4">
            <div class="px-4 py-2 sm:px-0 md:col-span-2">
              ...
              <input name="name" required type="text" value="" placeholder="np. 5pi" class="w-full text-gray-400 text-sm focus:text-white bg-[#0e0e0e] focus:ring-0 focus:outline-0 border-b border-white/10 py-2 theme-border-focus duration-150"></input>
            </div>
            <div class="px-4 py-2 sm:px-0 md:col-span-2">
              <dt class="text-sm font-medium leading-6 text-gray-300">Profil</dt>
              <input name="profile" required type="text" value="" placeholder="np. technik informatyk 😎" class="w-full text-gray-400 text-sm focus:text-white bg-[#0e0e0e] focus:ring-0 focus:outline-0 border-b border-white/10 py-2 theme-border-focus duration-150"></input>
            </div>
            <div class="px-4 py-2 sm:px-0 md:col-span-2">
              <dt class="text-sm font-medium leading-6 text-gray-300">Rocznik</dt>
              <input name="rocznik" required type="text" value="" placeholder="np. 2023/2024" class="w-full text-gray-400 text-sm focus:text-white bg-[#0e0e0e] focus:ring-0 focus:outline-0 border-b border-white/10 py-2 theme-border-focus duration-150"></input>
            </div>
        </div>
