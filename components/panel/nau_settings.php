      ...
      <header class=" border-b border-white/5">
        ...
        <nav class="flex overflow-x-auto py-4">
          <ul role="list" class="flex min-w-full flex-none gap-x-6 px-4 text-sm font-semibold leading-6 text-gray-400 sm:px-6 lg:px-8">
            ...
            <li class="active:scale-95 duration-150">
              <a onclick="forOpenSettings('components/panel/settings/nau_przedmioty.php')" id="nau_przedmioty" class="cursor-pointer settingsnav-buttons theme-text-hover duration-150">Twoje przedmioty</a>
            </li>
          </ul>
        </nav>
      </header>
